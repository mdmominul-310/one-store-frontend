...
const CheckoutPage = () => {
    ...
    const { selectedItems, totalItems, totalSelectedPrice, clearToCart } = useCart();
            ...
            >
                ...
                <div className='grid grid-cols-12 gap-8'>
                    <div className='lg:col-span-7 col-span-12'>
                        ...
                        <div className=''>
                            <div className=''>
                                <div className='flex gap-4'>
                                    ...
                                    >
                                        <Input className='w-full h-11' placeholder='Customer Name' />
                                    </Form.Item>
                                ...
                                >
                                    <Input className='w-full h-11' placeholder='Shipping Address' />
                                </Form.Item>
                                <Form.Item<FieldType>
                                    label="Delivery Area"
                                    name={"deliveryArea"}
                                    rules={[{ required: true, message: 'Please input your Delivery Area!' }]}
                                >
                                    <Select onChange={(e) => {
                                        if (e === "insideDhaka") {
                                    ...
                                    >
                                        <Select.Option value="insideDhaka">Inside Dhaka</Select.Option>
                                        <Select.Option value="outSideDhaka">Outside Dhaka</Select.Option>
                                ...
                                <Form.Item<FieldType>
                                    label="Note (Optional)"
                                    name={"note"}
                                    rules={[{ required: false, message: 'Please input your Order Note !' }]}
                                >
                                    <Input.TextArea className='w-full' placeholder='Aditional Information (Anything you want to add)' />
                                </Form.Item>
                            </div>
                        ...
                        <div>
                            ...
                            <div className='flex items-center'>
                                <input type="radio" className='w-4 h-4 mr-5' value="N" checked />  <span>Cash On Delivery</span>
                            </div>
                    ...
                    <div className='lg:col-span-5 col-span-12'>
                        ...
                        <h2 className='mb-5 mt-2 border-b-2 pb-2'>YOUR CART: {totalItems} ITEMS</h2>
                        ...
                        <button className="bg-primary font-semibold text-white rounded hover:bg-secondary duration-300 p-2 w-full my-5" >PLACE ORDER</button>
                    </div>
                </div>
            </Form>
