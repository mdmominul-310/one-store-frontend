...
const wishListInfoSlice = createSlice({
    ...
    reducers: {
        ...
        removeWishList: (state, action) => {
            const WishList = action.payload;
            state.wishListInfo = state.wishListInfo.filter((x) => x.id !== WishList.id);
        },
        clearWishList: (state) => {
            state.wishListInfo = [];
        },
...
export const { addWishList, removeWishList, clearWishList, addWishListQuantity, subtractQuantity, addSelectedAllWishList, addSelectedWishList } = wishListInfoSlice.actions;
