        ...
        <div className="my-8">
            ...
            <div>
                <div className="border-b-2  flex mb-8 flex-col items-center relative">
                    <h2 className='md:text-2xl text-xl  font-medium pb-2 text-center uppercase '>Flash Sale</h2>
            ...
            <div className="my-5 ">
                <div className="border-b-2  flex mb-8 flex-col items-center relative">
                    <h2 className='md:text-2xl text-xl  font-medium pb-2 text-center uppercase '>Top Products</h2>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <Link to="/all-products" className="flex justify-center w-[300px] items-center mt-10 bg-gray-200 p-2  hover:bg-primary hover:text-white rounded-lg">
