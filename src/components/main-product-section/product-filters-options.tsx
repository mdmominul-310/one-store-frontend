...
const ProductFilterOptions = ({ onChange, price, onChangeCT, category, categories }: IProductFilterOptions) => {
                    ...
                    <Space direction="vertical">
                        {
                            priceFilterOptions.map((price: IPriceFilterOptions) => (
                                <Radio key={price.value} value={price.value}>{price.label}</Radio>
                            ))
                        }
                    </Space>
                </Radio.Group>
                    ...
                    <Space direction="vertical">
                        {
                            categories?.data?.map((category: ICategory) => (
                                <Radio key={category._id} value={category.name}>{category.name}</Radio>
                            ))
                        }
                    </Space>
                </Radio.Group>
